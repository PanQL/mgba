...
CONFIGURATION = --extra-libs=libarchive --yasm=
...
CFLAGS   = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -Werror=format-security -Wstrict-prototypes -Wmissing-prototypes -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99 -Werror-implicit-function-declaration -D_ISOC99_SOURCE -I. -Iffmpeg -O4 -march=native -mtune=native -pipe -ffast-math -fomit-frame-pointer -fno-tree-vectorize -fno-asynchronous-unwind-tables -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE  -fpie -DPIC -D_REENTRANT  -DZLIB_CONST
CXXFLAGS = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -Werror=format-security  -D_ISOC99_SOURCE -I. -Iffmpeg -O4 -march=native -mtune=native -pipe -ffast-math -fomit-frame-pointer -fno-tree-vectorize -fno-asynchronous-unwind-tables -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS  -fpie -DPIC -D_REENTRANT  -DZLIB_CONST 
CC_DEPFLAGS = -MMD -MP
...
EXTRALIBS          =  -Wl,--version-script,binary.ver -Wl,-z,noexecstack  -ffast-math -fpie -pie   -lrt -lz   -rdynamic -lm  libarchive
EXTRALIBS_MPLAYER  = 
EXTRALIBS_MENCODER = 
...
X86ASMFLAGS = -f elf  -DPIC -m amd64 -o$@
...
CONFIG_STATIC = yes
SRC_PATH      = .
DST_PATH      = /media/sf_mgba/MPlayer-1.4/ffmpeg
LIBPREF       = lib
LIBSUF        = .a
